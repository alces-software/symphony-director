...
case $GROUP in
  centos6)
    ...
    #Get distro files
    curl $BASEURL/initrd.img > $SYMPHONY_HOME/cobbler/distro_files/CentOS6_initrd
    curl $BASEURL/vmlinuz > $SYMPHONY_HOME/cobbler/distro_files/CentOS6_kernel
    #Create distro
    cobbler distro add --name CentOS6 --kernel=$SYMPHONY_HOME/cobbler/distro_files/CentOS6_kernel --initrd=$SYMPHONY_HOME/cobbler/distro_files/CentOS6_initrd --arch=x86_64 --ksmeta="tree=centos/6 url=$INSTALLURL" --breed redhat --os-version=rhel6 --kopts="syslog=@@server@@" --clobber
    #Create Profile
  ...
  sl6)
    ...
    #Get distro files  
    curl $BASEURL/initrd.img > $SYMPHONY_HOME/cobbler/distro_files/SL6_initrd
    curl $BASEURL/vmlinuz > $SYMPHONY_HOME/cobbler/distro_files/SL6_kernel
    #Create distro
    cobbler distro add --name SL6 --kernel=$SYMPHONY_HOME/cobbler/distro_files/SL6_kernel --initrd=$SYMPHONY_HOME/cobbler/distro_files/SL6_initrd --arch=x86_64 --ksmeta="tree=sl/6 url=$INSTALLURL" --breed redhat --os-version=rhel6 --kopts="syslog=@@server@@" --clobber
    #Create Profile
  ...
  rhel6)
    ...
    curl $BASEURL/initrd.img > $SYMPHONY_HOME/cobbler/distro_files/RHEL6_initrd
    curl $BASEURL/vmlinuz > $SYMPHONY_HOME/cobbler/distro_files/RHEL6_kernel
    #Create distro
    cobbler distro add --name RHEL6 --kernel=$SYMPHONY_HOME/cobbler/distro_files/RHEL6_kernel --initrd=$SYMPHONY_HOME/cobbler/distro_files/RHEL6_initrd --arch=x86_64 --ksmeta="tree=rhel/6 url=$INSTALL_URL" --breed redhat --os-version=rhel6 --kopts="syslog=@@server@@" --clobber
    #Create Profile
  ...
  rhelcomputenode6)
    ...
    curl $BASEURL/initrd.img > $SYMPHONY_HOME/cobbler/distro_files/RHELCOMPUTENODE6_initrd
    curl $BASEURL/vmlinuz > $SYMPHONY_HOME/cobbler/distro_files/RHELCOMPUTENODE6_kernel
    #Create distro
    cobbler distro add --name RHELCOMPUTENODE6 --kernel=$SYMPHONY_HOME/cobbler/distro_files/RHELCOMPUTENODE6_kernel --initrd=$SYMPHONY_HOME/cobbler/distro_files/RHELCOMPUTENODE6_initrd --arch=x86_64 --ksmeta="tree=rhelcomputenode/6 url=$INSTALL_URL" --breed redhat --os-version=rhel6 --kopts="syslog=@@server@@" --clobber
    #Create Profile
  ...
  centos7)
    ...
    #Get distro files
    curl $BASEURL/initrd.img > $SYMPHONY_HOME/cobbler/distro_files/CentOS7_initrd
    curl $BASEURL/vmlinuz > $SYMPHONY_HOME/cobbler/distro_files/CentOS7_kernel
    #Create distro
    cobbler distro add --name CentOS7 --kernel=$SYMPHONY_HOME/cobbler/distro_files/CentOS7_kernel --initrd=$SYMPHONY_HOME/cobbler/distro_files/CentOS7_initrd --arch=x86_64 --ksmeta="tree=centos/7 url=$INSTALLURL" --breed redhat --os-version=rhel7 --kopts="syslog=@@server@@" --clobber
    #Create Profile
  ...
  sl7)
    ...
    #Get distro files
    curl $BASEURL/initrd.img > $SYMPHONY_HOME/cobbler/distro_files/SL7_initrd
    curl $BASEURL/vmlinuz > $SYMPHONY_HOME/cobbler/distro_files/SL7_kernel
    #Create distro 
    cobbler distro add --name SL7 --kernel=$SYMPHONY_HOME/cobbler/distro_files/SL7_kernel --initrd=$SYMPHONY_HOME/cobbler/distro_files/SL7_initrd --arch=x86_64 --ksmeta="tree=sl/7 url=$INSTALLURL" --breed redhat --os-version=rhel7 --kopts="syslog=@@server@@" --clobber
    #Create Profile 
